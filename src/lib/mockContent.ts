  ...
  const content: Record<string, string[][]> = {
    'erp-selection-checklist-smb': [
      ...
      [
        ...
        '• Map the personal information held in the ERP, where it is stored, who can access it, overseas support arrangements, retention rules, and how APP 8 and APP 11 obligations are addressed where applicable.',
        '• Ask the vendor and partner to demonstrate multi-factor authentication, privileged-access control, patching responsibilities, backup and recovery, logging, incident response, and alignment with the organisation’s cyber baseline.',
      ...
      ['## 5. Assess data migration and integration risk'],
      [
      ...
      ['## 6. Evaluate the implementation partner beside the software'],
      [
      ...
      ['## 7. Compare total cost and commercial exposure'],
      [
      ...
      ['## 8. Use gates and weighted scoring'],
      [
      ...
      [
        '• Australian Taxation Office eInvoicing guidance and eInvoicing Ready product register.',
        '• Office of the Australian Information Commissioner Australian Privacy Principles guidance, including APP 8 and APP 11.',
        '• Australian Signals Directorate Essential Eight guidance and maturity model.',
...
export const mockGuides: GuideDoc[] = [
  {
    ...
    seo: {
      ...
      metaDescription: 'Use this ERP selection checklist to compare software, partners, Australian requirements, security, data, implementation risk, and total cost.',
    },
