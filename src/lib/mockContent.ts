  ...
  },
  {
    ...
    body: skimmableBlocks(
      [
        ...
        'Oracle\'s own product pages describe the commercial structure more usefully: an annual licence made up of the core platform, optional modules, and the number of users, plus a one-time implementation fee. That gives buyers a reliable framework even when the final dollar values remain quote-led.',
      ...
      [
        '• Core platform: Oracle describes the platform licence as the base of the annual subscription. Buyers should make the included finance, reporting, CRM, inventory, and administration scope explicit rather than relying on a package name alone.',
        ...
        '• Optional modules: Oracle says modules can be licensed separately and added during the contract. Module fees vary because the capabilities vary, so each module should have a named business owner and phase.',
      ...
      [
        ...
        '• Operational depth: warehouse mobility, advanced manufacturing, planning, ecommerce, field service, subscription billing, and enterprise performance management can introduce separate modules or SuiteApps.',
      ...
      [
        ...
        '• Release notes and product announcements do not prove entitlement. The contract, order form, and module list should identify what the account will actually receive.',
      ],
      ...
      [
        ...
        '• Keep optional modules outside the approved phase-one baseline unless the business case depends on them. Oracle states that modules can be activated later, which supports a staged approach when integration and process consequences are understood.',
      ...
      ['## Official sources'],
      [
        '• Oracle NetSuite, What is NetSuite ERP & How Does It Work?, for the current licence and implementation-fee structure.',
        '• Oracle NetSuite Modules Guide, for optional-module licensing and the distinction between modules and SuiteApps.',
        '• Oracle NetSuite product pages for general ledger, financial consolidation, close management, and supply chain management, for included and add-on capability boundaries.',
        '• Oracle NetSuite ERP pricing and implementation-cost guides, for the cost drivers that belong in a complete business case.',
      ],
    ),
  },
  {
