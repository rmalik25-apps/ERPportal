...
export const mockPosts: PostDoc[] = [
  ...
  {
    _id: 'post-bc-subcontracting-quality-2026',
    _type: 'post',
    title: 'Business Central manufacturing in 2026: what to test in subcontracting and quality management',
    slug: 'business-central-manufacturing-2026-subcontracting-quality-management',
    excerpt: 'Microsoft\'s current Business Central roadmap puts subcontracting and quality management in focus. Here is what Australian manufacturing teams should validate before treating those updates as production-ready change.',
    category: 'Business Central',
    publishedAt: '2026-05-04T00:00:00Z',
    updatedAt: '2026-05-04T00:00:00Z',
    seo: {
      metaTitle: 'Business Central Manufacturing 2026: Subcontracting and Quality Management',
      metaDescription:
        'Practical Business Central guide for Australian manufacturers reviewing 2026 subcontracting and quality-management changes, rollout timing, and testing priorities.',
    },
    body: skimmableBlocks(
      [
        'For this run, the strongest Australian content gap was not another generic pricing page. It was a current Business Central manufacturing topic that connects Microsoft\'s 2026 release activity with practical buyer and rollout questions for operations teams that use subcontractors, external processors, or formal quality controls.',
        'That matters because Microsoft\'s current 2026 release wave 1 overview explicitly calls out subcontracting and quality-management enhancements in Business Central, while the detailed feature pages split the timing: the Quality Management extension is already generally available from 1 April 2026, but the new subcontracting capabilities are still planned for general availability in June 2026.',
        'For Australian manufacturers, food producers, and distribution businesses with light assembly or outsourced processing, the real question is not whether the roadmap sounds useful. It is whether the operating model, data, warehouse handling, and release sequencing are mature enough to turn these features into usable production control rather than another half-configured experiment.',
      ],
      ['## What Microsoft has officially shipped or scheduled'],
      [
        '• Microsoft\'s 2026 release wave 1 overview for Business Central says this release invests in manufacturing and supply chain, with specific emphasis on subcontracting and quality management.',
        '• Microsoft\'s detailed subcontracting feature page says the capability is planned for general availability in June 2026 and includes subcontractor transfers for raw materials and components, flexible pricing by work center or item context, finished-goods receipts from purchase orders with warehouse handling and item tracking, and more production-process transparency.',
        '• Microsoft\'s Quality Management feature page says the extension reached general availability on 1 April 2026. Microsoft also says it installs automatically on newly deployed environments, while upgraded environments can install it from AppSource.',
      ],
      ['## Why this matters for Australian manufacturing teams'],
      [
        '• Many Australian SMB manufacturers rely on external processors for coating, cutting, packaging, blending, or other specialist steps. Those businesses do not just need MRP. They need reliable control over stock transfers, subcontractor costing, receipt timing, and quality release decisions.',
        '• This is especially relevant where one ERP platform is expected to cover finance, inventory, light warehouse handling, and production without adding a separate manufacturing execution layer too early.',
        '• The buyer risk is assuming “Microsoft has it on the roadmap” means the operational design is now solved. In practice, subcontracting and quality features only help when routing discipline, item tracking, vendor setup, and quarantine rules are already owned properly.',
      ],
      ['## What already exists in standard subcontracting'],
      [
        '• Microsoft\'s current subcontract-manufacturing documentation shows Business Central already supports subcontract work centers linked to vendors, with costing based on time or flat unit charges.',
        '• Microsoft also documents a subcontracting worksheet that calculates released production orders and creates purchase orders for subcontract operations from routing data.',
        '• That matters because the new 2026 feature should be evaluated against the existing baseline. Teams should be clear whether they need genuinely new logistics and transparency, or whether the current setup has simply not been implemented with enough discipline yet.',
      ],
      ['## What to test before relying on the June 2026 subcontracting changes'],
      [
        '• Material-transfer design. Microsoft says the new capability will manage transfers for raw materials, components, and finished goods with warehouse handling and item tracking. Test whether your real subcontract flow uses locations, bins, lots, serials, or staged transfers in ways the standard model can support cleanly.',
        '• Pricing logic. The release page says pricing can consider work center, item, dates, and quantity. Validate whether your supplier commercials are stable enough to map into that structure, especially where tooling charges, yield loss, or short-run premiums are common.',
        '• Production-order status and timing. Microsoft\'s current subcontracting worksheet only works from released production orders. If planning discipline is weak or orders are released late, better subcontracting features will not rescue the process.',
        '• Receipt behaviour. Microsoft\'s current documentation warns that receiving a subcontract purchase order can automatically post output when the subcontracted operation is the last routing step. Teams should test this carefully against their real output and posting-date controls before changing floor procedures.',
      ],
      ['## What to test before turning on Quality Management'],
      [
        '• Trigger points. Microsoft says quality checks can run at purchase receipt, production output, assembly output, or on a manual or scheduled basis. Decide which events genuinely protect risk in your operation rather than checking everything because the extension allows it.',
        '• Scope and sampling. Microsoft says checks can apply at item, group, lot, serial, or package level, and can define fixed or percentage samples for external analysis. That should be matched to your actual QA policy, not copied from a demo environment.',
        '• Quarantine and release ownership. Microsoft documents quarantine procedures to freeze items or prevent immediate use. The important design question is who can release stock, who investigates failures, and how the warehouse knows whether stock is usable.',
        '• Reporting evidence. Microsoft highlights quality certificates, certificates of analysis, quality status overview, and quality orders overview. Test whether those outputs satisfy your customer, audit, or regulatory evidence needs before assuming spreadsheets can disappear.',
      ],
      ['## Where projects usually go wrong'],
      [
        '• Treating quality as a QA-only feature. It is really a cross-functional control design touching receiving, production, warehousing, customer commitments, and finance valuation.',
        '• Confusing roadmap timing with rollout readiness. As of 4 May 2026, the quality extension is already generally available, while the new subcontracting capability is still scheduled for June 2026. Those are different adoption conversations.',
        '• Ignoring master-data readiness. Vendor records, routing design, quality parameters, item tracking, and location policy all need more discipline once Business Central starts enforcing tighter manufacturing controls.',
        '• Piloting on the hardest plant or the messiest supplier first. The better sequence is one product family, one subcontractor pattern, and one clearly owned quality workflow.',
      ],
      ['## A sensible first pilot'],
      [
        '• Start with one released production flow that already uses stable routing and vendor data, then test subcontract purchasing, material transfer, receipt, and costing end to end.',
        '• Add one quality-control scenario with clear pass, fail, and quarantine outcomes so warehouse, production, and finance can all validate the operational consequences.',
        '• Measure exception rate, receipt turnaround, stock status visibility, rework effort, and whether month-end valuation becomes clearer or more confusing.',
        '• Keep the pilot grounded in a real industry scenario such as toll processing, outsourced packaging, or inbound quality release rather than a generic manufacturing demo.',
      ],
      ['## What buyers should conclude now'],
      [
        '• Business Central\'s current manufacturing roadmap is materially more relevant in 2026 than a year ago if your operation needs stronger subcontractor and quality controls.',
        '• The strongest fit is a manufacturer that wants to stay on a unified SMB ERP platform and has enough process discipline to benefit from better control points.',
        '• If your production routing, warehouse ownership, or QA policy is still informal, fix that first. Otherwise these features will expose process ambiguity faster than they create value.',
      ],
      ['## FAQ'],
      [
        '• Is the new subcontracting capability already live? Not fully. Microsoft\'s release-plan page lists it for general availability in June 2026, so teams should treat it as scheduled, not assumed-live, on 4 May 2026.',
        '• Is Quality Management already available? Yes. Microsoft lists the extension as generally available from 1 April 2026, with automatic install on new environments and AppSource install for upgraded ones.',
        '• Does this remove the need for a specialist manufacturing or quality add-on? Not necessarily. It strengthens the standard Business Central option, but complex regulated or high-variability operations may still need deeper vertical capability.',
      ],
    ),
  },
]
