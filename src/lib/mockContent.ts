...
export const mockPosts: PostDoc[] = [
  ...
  {
    _id: 'post-bc-agents-au-where-to-start',
    _type: 'post',
    title: 'Business Central AI agents in Australia: where to start with Payables Agent vs Sales Order Agent',
    slug: 'business-central-ai-agents-australia-payables-vs-sales-order',
    excerpt:
      'A practical Australian guide to choosing the first Business Central AI agent to pilot, based on current Microsoft setup rules, language support, billing, and process risk.',
    category: 'Business Central',
    publishedAt: '2026-05-15T00:00:00Z',
    updatedAt: '2026-05-15T00:00:00Z',
    seo: {
      metaTitle: 'Business Central AI Agents in Australia: Payables vs Sales Order',
      metaDescription:
        'Australian buyer guide to Business Central Payables Agent vs Sales Order Agent covering Microsoft prerequisites, supported languages, billing, limitations, and rollout priorities.',
    },
    body: skimmableBlocks(
      [
        'Australian ERP search interest around Business Central is still strongest when Microsoft AI claims connect to one real workflow, one clear owner, and one concrete rollout decision. That makes agent selection more commercially useful right now than another generic Copilot overview.',
        'As of 15 May 2026, Microsoft has current setup, FAQ, and release-plan documentation for both Payables Agent and Sales Order Agent, while the local Microsoft Business Central site now markets the platform around “agentic resource planning”. For Australian buyers, the practical question is not whether AI exists in Business Central. It is which agent is the safer first pilot for your operating model.',
        'The short answer is usually this: finance-led teams with repetitive PDF invoice intake should start with Payables Agent, while distribution or inside-sales teams with repeatable email-based order capture should evaluate Sales Order Agent first. The rest of this guide explains why.',
      ],
      ['## Why this topic matters now'],
      [
        '• Microsoft\'s Business Central 2026 release wave 1 plan, published on 18 March 2026, explicitly positions the product around AI-powered agents and lists new supervision features such as a dedicated task pane for all agents, direct review of agent-generated content on pages, and mailbox visibility for Payables Agent processing.',
        '• Microsoft\'s Australian Business Central product page now uses the phrase “agentic resource planning”, which is a stronger commercial signal than the older Copilot-assistant positioning.',
        '• CPA Australia\'s Business Technology Report 2025 shows AI adoption is already a mainstream management issue for Australian businesses, so buyers now need practical pilot guidance rather than broad AI messaging.',
      ],
      ['## What each agent actually does'],
      [
        '• Payables Agent monitors a Microsoft 365 mailbox for vendor invoice PDFs, extracts invoice data, identifies or helps create vendors, suggests coding, and prepares draft purchase invoices for review inside Business Central.',
        '• Sales Order Agent monitors a Microsoft 365 mailbox for customer quote or order requests, identifies customers and items, checks item availability, prepares quotes, manages follow-up email exchanges, and converts approved quotes into sales orders.',
        '• Both agents work inside Business Central, run under agent identities with permission controls, and rely on human review when confidence or policy thresholds require it.',
      ],
      ['## The most important differences for Australian teams'],
      [
        '• Best starting process: Payables Agent fits inbox-heavy AP teams. Sales Order Agent fits email-led quote-to-order teams.',
        '• Language support: Payables Agent is validated for supported English locales including Australia, New Zealand, the United Kingdom, and the United States. Sales Order Agent supports a broader list, including English (Australia) plus several European languages.',
        '• Mailbox permissions: Payables Agent needs Full Access to the monitored mailbox. Sales Order Agent needs Full Access and Send as permission because it also prepares and sends customer-facing email responses.',
        '• Billing model: Payables Agent documentation says activated agents use Microsoft Copilot Studio messages. Sales Order Agent documentation says the feature uses Copilot Credits when users run it. In both cases, Australian teams should treat usage as a real operating cost and not assume it sits invisibly inside the base subscription.',
        '• Process risk: Payables Agent creates internal draft purchase documents. Sales Order Agent influences customer communication, delivery promises, and order capture, which means the commercial downside of bad configuration is usually higher.',
      ],
      ['## When Payables Agent should come first'],
      [
        '• Your AP team receives a steady flow of supplier invoice PDFs by email and spends too much time on document registration or first-pass coding.',
        '• Supplier master data is reasonably clean, purchase invoice review already has owners, and the business can protect one dedicated AP mailbox from noise.',
        '• The business wants an internal pilot with lower customer-facing risk. Even if the agent makes weak suggestions, drafts stay inside finance review before posting.',
        '• You can work within Microsoft\'s current product limits. Microsoft says Payables Agent only processes emails with PDF attachments, skips emails with more than 10 attachments, does not process PDFs over 10 pages or 5 MB, and currently does not support purchase order matching, approval flows, or anomaly detection.',
      ],
      ['## When Sales Order Agent should come first'],
      [
        '• Your business still receives a meaningful share of quote and order traffic by email, especially for standard catalogue items.',
        '• Customer master data, contact ownership, item records, and availability rules are good enough that the agent can match senders and build usable quotes without constant manual rescue.',
        '• The business sees value in reducing sales-admin drafting effort and wants faster quote turnaround or better inbox discipline.',
        '• You are prepared for a tighter governance model. Because the agent can drive outbound customer communication and order conversion, review checkpoints, pricing rules, and mailbox ownership need to be stronger before rollout.',
      ],
      ['## Where Microsoft\'s current release cycle changes the decision'],
      [
        '• Business Central 2026 release wave 1 adds supervision tooling that makes agent pilots more manageable, including a dedicated task pane for all agents and direct review of generated content on pages from April 2026.',
        '• The same release plan includes “Discover emails in the mailbox that have been processed by Payables Agent”, also targeted for April 2026. That matters because AP pilots often fail when teams lose visibility into what the mailbox agent already touched.',
        '• These updates strengthen the case for starting with a narrowly scoped pilot now rather than waiting for a perfect future wave. The governance layer is becoming more usable even while the underlying agents continue to evolve.',
      ],
      ['## A practical first-pilot decision rule'],
      [
        '• Choose Payables Agent first if you want the lower-risk pilot. It stays inside finance control, has clearer document inputs, and usually exposes process issues without directly affecting customer communication.',
        '• Choose Sales Order Agent first only if email order capture is already operationally significant and your commercial process is disciplined enough to handle AI-assisted quote drafting and follow-up review.',
        '• Do not start with both. One mailbox, one process owner group, one success metric pack, and one operating-cost review is the cleaner way to learn.',
      ],
      ['## What Australian teams should test before committing budget'],
      [
        '• Mailbox operating model: one shared inbox, one owner group, and clear rules about whether users still touch that mailbox in Outlook.',
        '• Data quality: vendor matching for AP, customer and item matching for sales, and the exception rate caused by weak master data.',
        '• Human review design: which steps require review, who owns them, what turnaround time is acceptable, and how unresolved tasks are escalated.',
        '• Billing visibility: monthly interaction estimates, AI-credit or message consumption assumptions, and how those costs are explained back to finance.',
        '• Pilot KPIs: draft creation speed, exception rate, user correction effort, task backlog, and business impact by workflow.',
      ],
      ['## What ERP Search would recommend right now'],
      [
        '• For most Australian SMBs, Payables Agent is the stronger first pilot because the workflow is narrower, the document format is more predictable, and the business risk stays inside finance review.',
        '• Sales Order Agent becomes the better first choice only when order capture by email is already a material bottleneck and catalogue, pricing, and customer-data discipline are stronger than average.',
        '• In both cases, the value is not “switch on AI”. The value is whether the business can turn one repetitive inbox workflow into a controlled, measurable process inside Business Central.',
      ],
      ['## FAQ'],
      [
        '• Are these agents relevant in Australia right now? Yes. Microsoft\'s current Business Central documentation includes Australian language support for Sales Order Agent and supported English locales including Australia for Payables Agent, while Microsoft\'s Australian product marketing now foregrounds AI agents.',
        '• Which agent has the lower-risk rollout? Usually Payables Agent, because the workflow is internal and draft-based rather than customer-facing.',
        '• Can we run both agents from one mailbox? No. Microsoft\'s Payables Agent overview explicitly warns against using the same mailbox for other agents such as Sales Order Agent because it can create ownership conflicts over incoming email.',
        '• Should current customers and new buyers care equally? Yes. Existing customers need pilot discipline, while new buyers should use these agent workflows to test whether a partner can demonstrate Business Central in practical operating terms rather than generic AI language.',
      ],
    ),
  },
  {
