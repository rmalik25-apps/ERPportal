...
const guideLinks: Record<string, RelatedLink[]> = {
  ...
  'business-central-implementation-wholesale-distribution': [
    ...
    {href: '/blog/business-central-manufacturing-2026-subcontracting-quality-management/', label: 'Business Central manufacturing in 2026'},
    {href: '/guides/business-central-pricing-australia-licences-budget/', label: 'Business Central pricing in Australia'},
...
const blogLinks: Record<string, RelatedLink[]> = {
  ...
  'business-central-manufacturing-2026-subcontracting-quality-management': [
    {href: '/guides/business-central-manufacturing-mrp-shop-floor/', label: 'Business Central for manufacturing: MRP and shop floor essentials'},
    {href: '/blog/review-business-central-release-notes-without-project-churn/', label: 'How to review Business Central release notes'},
    {href: '/blog/warehouse-kpis-that-tell-you-when-erp-needs-wms/', label: 'Warehouse KPIs that tell you when ERP needs a WMS'},
    {href: '/blog/food-erp-projects-scope-warehouse-quality-and-production-together/', label: 'Food ERP projects: scope warehouse, quality, and production together'},
