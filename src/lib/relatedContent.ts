...
const guideLinks: Record<string, RelatedLink[]> = {
  ...
  'ai-agents-for-erp-automation-with-control': [
    ...
    {href: '/guides/top-10-erp-automations-save-time/', label: 'Top 10 ERP automations to save time'},
    {href: '/blog/support-ticket-to-erp-task-automation-australia-controls/', label: 'Support ticket to ERP task automation checklist'},
    {href: '/blog/warehouse-receiving-picking-exception-automation-erp-australia/', label: 'Warehouse receiving and picking automation checklist'},
    {href: '/blog/bank-reconciliation-automation-erp-australia-controls-checklist/', label: 'Bank reconciliation automation checklist'},
    {href: '/blog/inventory-replenishment-automation-erp-australia-controls-checklist/', label: 'Inventory replenishment automation checklist'},
